...
class registroAnimalesController extends Controller
{
    ...
    public function store(Request $request){
        ...
        DB::insert('INSERT INTO animales (nombre, codigo, sexo, peso, edad, raza, numeroVacunas, numeroCrias) VALUES (?, ?, ?, ?, ?, ?, ?, ?)', [$datos['nombre'], $datos['codigo'],$datos['sexo'],$datos['peso'],$datos['edad'],$datos['raza'],$datos['numeroVacunas'],$datos['numeroCrias']]);
